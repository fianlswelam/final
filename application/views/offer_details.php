                    ...
                    <div class=" sub-header" style="margin-top:-30px;">
                        <div class="row-fluid">
                            <div class="span8 offset2">
                                <h3><?php echo $row->name; ?><i class="icon-file"></i></h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="span8 offset2">
                            <div class="dash-tile">
                                <div class="dash-tile-header">
                                    ...
                                    <span class="label label-important">تمت الأضافة فى  : <?php  ?></span> 
...
<!--                                                    <tr>
                                        ...
                                        <a href="<?php echo base_url(); ?>site/offer_reqest/<?php echo $row->id ?>" class="btn-primary" style="padding:10px;margin:15px 0 15px 0" >الاشتراك فى العرض  </a>
