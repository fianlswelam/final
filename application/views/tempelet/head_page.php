                    ...
                    <div class="container-fluid">
                        ...
                        <!----------------------------------->
                                ...
                                <ul class="dropdown-menu widget pull-right">
                                    ...
                                    <li class="new-on">
                                        <div class="media">
                                            <a class="pull-left" href="javascript:void(0)">
                                                <img id="msg_img" src="<?php echo base_url(); ?>images/image_light_64x64.png"  alt="fakeimg">
                                            </a>
                                            <div class="media-body">
                                                <h6 class="media-heading"><a href="javascript:void(0)">mohamed temraz</a></h6>
                                                <div class="media">هو بعد ما دخلت جوه علي المدونه اشتغل كويس</div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="media-heading"><a href="javascript:void(0)">temraz</a></h6>
                                                <div class="media">هو بعد ما دخلت جوه علي المدونه اشتغل كويس</div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="media-heading"><a href="javascript:void(0)">mohamed saad</a></h6>
                                                <div class="media">هو بعد ما دخلت جوه علي المدونه اشتغل كويس</div>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?php echo base_url(); ?>images/avatar.png"  alt="avatar"> <b class="caret"></b></a>
