                ...
                <ul class="thumbnails" data-toggle="gallery-options">
                 <?php if (!isset($filter_prices)) { ?>
                    ...
                    <?php
                        ...
                        $sql = 'SELECT id,name,duration,left( detail, 100 ) AS detail, photo_name FROM offers';
                            ...
                            foreach ($rows as $row) {
                                ...
                                <li class="span4" style="width: 200px; margin: 20px; padding: auto;">
                                    <div class="thumbnail" style="height: 220px;">
                                        <a href="<?php echo base_url(); ?>site/offers_details/<?php echo $row->id ?>">  
                                        ...
                                        <h4 style="color:#036"><?php echo $row->name ?></h4>
                                            ...
                                            <a  href="<?php echo base_url(); ?>site/offers_details/<?php echo $row->id ?>" class="btn btn-warning">الاشتراك فى العرض  </a>
                                       
                                         <h4 style="color:#036;text-align:left;margin-top:-20px;padding-left:5px;"> <?php echo $row->duration; ?> <small style="text-align:left">يوم </small></h4>
                                    </div>
                                </li>
