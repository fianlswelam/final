...
-->
<meta charset="UTF-8">
<title>عن موقع | شلينات دوت كوم</title>
...
<li class="active" style="text-align:right;float:right"><a href="<?php echo base_url();?>site/about">عن الموقع</a> <i class="icon-group"></i> </li>
</ul>
