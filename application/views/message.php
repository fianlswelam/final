...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <script src="main-1.2.js" tppabs="http://pixelcave.com/demo/uadmin/js/main-1.2.js"></script><script>
            $(function () {$('#error-tabs a').click(function (e) {e.preventDefault();$(this).tab('show');});});
        </script>
