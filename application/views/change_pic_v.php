...
<?php echo form_open_multipart('user/upload_pic',array('id'=>'form-validation'));  ?>
    <div style="color:#F00;">
...
<button type="submit" name="post_upload2" class="btn btn-success"><i class="icon-ok"></i> تغير الصوره</button>
</div>
</div>
</form>
</div>
