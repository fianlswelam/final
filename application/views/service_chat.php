        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <div id="page-content" >
                    ...
                    <?php
                    $order_id = $this->uri->segment(3); //s_id
								...
								';
                                        ...
                                        <div class="media media-hover">
                                            <a href="#" class="pull-left">
                                                <img src="http://localhost/shelenu/images/image_dark_64x64.png" tppabs="http://pixelcave.com/demo/uadmin/img/placeholders/image_dark_64x64.png" class="media-object img-polaroid" alt="Image">
                                            </a>
                                            <div class="media-body">
                                                <!--<form class="form-horizontal" onsubmit="return false;">-->
                                                <?php echo form_open('user/addcomment'); ?>
                                                ...
                                                <input type="hidden" name="employe_id" value="<?php echo $employee_id; ?>" />
